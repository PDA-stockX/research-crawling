...
import pdfjs from 'pdfjs-V2/legacy/build/pdf.js'; //pdfjs-dist/legacy/build/pdf.js
...
export default async function convert(pdf, conversion_config = {}) {
...
async function doc_render(pdfDocument, pageNo, canvasFactory, conversion_config) {
  ...
  let outputScale = conversion_config.scale * 3 || 3.0;
