import getContent from '../src/pdfjs.js';
import fs from 'fs';
...
(async () => {
    const url1 = 'https://ssl.pstatic.net/imgstock/upload/research/company/1701991295245.pdf';

    const text1 = await getContent(url1);

    fs.writeFileSync("./text1.json", JSON.stringify(text1));

    // console.log(text1);
    console.log(usePdfjs(text1));
})();
